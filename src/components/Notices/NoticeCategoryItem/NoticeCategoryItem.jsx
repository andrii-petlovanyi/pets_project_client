...
export const NoticeCategoryItem = () => {
    ...
    return (
        <Card maxW='288' h="606" boxShadow="7px 4px 14px rgba(49, 21, 4, 0.07)" borderRadius="0px 0px 40px 40px">
            <CardBody p="0"  >
                <Box>
                    <Image
            ...
            <CardFooter pb="30px">
                <Button type="button" variant={'outlineCardBtn'} >Learn more</Button>
                {/* <Button type="button" variant={'outlineCardBtn'}><Text mr={'13px'}>Delete</Text> <MdOutlineDeleteOutline size={'20px'} /></Button> */}
            </CardFooter>
        </Card>
    )
};
